...
public class ChatsActivity extends AppCompatActivity {
    ...
    private void bind_views() {
        ...
        ((Button) (findViewById(R.id.btn_pick_user_post))).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pick_user();
            }
        });
        ((Button) (findViewById(R.id.btn_pick_user_set))).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                pick_user();
            }
